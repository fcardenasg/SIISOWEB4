...
export const GetAllEvolutionNote = async () => await getData(Url.NotaEvolucion);
export const GetByIdEvolutionNote = async (id) => await getData(Url.NotaEvolucionId, { id });
export const SaveEvolutionNote = async (notaEvolucion) => await postData(Url.NotaEvolucion, notaEvolucion);
