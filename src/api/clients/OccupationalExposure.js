...
export const GetInformationFromExcel = async (files) => await postData(`${Url.ExposicionOcupacional}/extracted-list`, files);
export const ExtractInformationFromExcel = async (exposicionOcupacional) => await postData(`${Url.ExposicionOcupacional}/information-extracted`, exposicionOcupacional);
