...
export const GetAllByDocumentAndTypeOrder = async (page, pageSize, documento, typeOrder) => await getData(Url.RecetarioByDocAndOrder, { page, pageSize, documento, typeOrder });
