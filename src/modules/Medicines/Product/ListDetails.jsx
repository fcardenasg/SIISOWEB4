        ...
        <Fragment>
            ...
            <SubCard title={<Typography variant='h4'>Entrada de medicamento</Typography>}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                        <Transitions type="collapse" in={openTransition} position="top-left" direction="up">
                            ...
                            <Grid container sx={{ pr: 0.5, pt: 3 }} justifyContent="flex-end">
                                <Stack direction="row" spacing={1} alignItems="center">
                                    <AnimateButton>
                                        <Button color="error" onClick={() => setOpenTransition(false)}>
                                            Cancelar
                                        </Button>
                                    </AnimateButton>
                        ...
                        {!openTransition ?
                            <Grid item sx={{ pl: 2, pt: 3 }}>
                                <Button variant="text" onClick={() => setOpenTransition(true)}>
                                    + Agregar entrada
                                </Button>
                            </Grid> : null}
                    </Grid>
