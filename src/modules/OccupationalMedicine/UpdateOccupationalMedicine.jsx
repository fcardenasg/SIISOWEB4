...
const OccupationalMedicine = () => {
    ...
    const handleClick = async (datos) => {
        try {
            const DataToUpdate = PutOccupationalMedicine(id, documento, datos.resumenCaso, datos.situacionEmpleado, datos.fechaRetiro, datos.segmentoAgrupado,
                datos.segmentoAfectado, datos.subsegmento,
                datos.codDx, datos.nroFurel, datos.regionInfoLaboral, datos.lateralidad, datos.entidadQueMotivaEnvio, datos.entidadDondeEnvia, datos.fechaEntrega,
