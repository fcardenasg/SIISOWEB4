                ...
                <Grid container justifyContent="center" spacing={gridSpacing}>
                                    ...
                                    <Grid container spacing={gridSpacing}>
                                        ...
                                        <Grid item xs={12}>
                                            <Grid container spacing={2}>
                                                <Grid item xs={12}>
                                                    <Typography align="center" variant="h5"><b>DATOS BÁSICOS DE LA ATENCIÓN</b></Typography>
                                                </Grid>
                    ...
                    <Grid item xs={12}>
                        <Grid container alignItems="center" justifyContent="center" spacing={2}>
                            ...
                            <Grid item xs={2}>
                                <AnimateButton>
                                    <Button fullWidth variant="outlined" onClick={() => navigate('/note-infirmary/list')}>
                                        Cerrar
                                    </Button>
                                </AnimateButton>
                            </Grid>
