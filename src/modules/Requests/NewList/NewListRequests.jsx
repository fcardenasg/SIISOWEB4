...
import { DeleteVentanillaUnica, GetAllVentanillaUnica } from 'api/clients/VentanillaUnicaClient';
...
const NewListRequests = () => {
    ...
    async function getAll() {
        try {
            const lsServer = await GetAllVentanillaUnica();
    ...
    const handleSearch = (event) => {
        ...
        if (newString) {
            const newRows = rows.filter((row) => {
                ...
                const properties = ['documento', 'nombre', 'nameTipo', 'fechaRecibido', 'telefono', 'fechaRegistro'];
    ...
    return (
        <MainCard title="Lista De Peticiones" content={false}>
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={6}>
                                <Button fullWidth variant="contained" size="large" startIcon={<AddCircleOutlineOutlinedIcon />}
                                    onClick={() => navigate("/requests/new-addrequests")}>
                                    {TitleButton.Agregar}
                                </Button>
                            </Grid>
                                        ...
                                        >
                                            ...
                                            >
                                                <Typography
                                                    ...
                                                    sx={{ color: theme.palette.mode === 'dark' ? 'grey.600' : 'grey.900' }}
                                                >
                                                    {ViewFormat(row.fechaRecibido)} - {ViewFormat(row.fechaLimiteRespuesta)}
                                                </Typography>
                                            </TableCell>
...
export default NewListRequests;