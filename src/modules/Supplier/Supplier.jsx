...
import { Message, TitleButton, ValidationMessage, CodCatalogo, AccionMenu, Modulo } from 'components/helpers/Enums';
...
const Supplier = () => {
    ...
    return (
        <ValidateActionSkeleton idAccion={AccionMenu.agregar} idModulo={Modulo.Proveedor}>
