...
/* Pag. 1 */
function pageFramingham(doc, lsDataReport = [], lsDataUser = []) {
    ...
    doc.text(`${lsDataReport.nameFuma}`, 116, 86);
...
export function generateReportFramingham(lsDataReport = [], lsDataUser = []) {
