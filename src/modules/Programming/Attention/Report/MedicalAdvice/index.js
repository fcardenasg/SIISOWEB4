...
function generateReportMedicalAdvice(doc = new jsPDF(), lsDataReport = [], lsDataUser) {
    ...
    doc.text(`MOTIVO: ${lsDataReport.nameMotivo}`, marXR - 2, 95, { align: 'right' });

    /* DESCRIPCIONES DE TEXTO */
    doc.setFontSize(9);
    doc.text(`${lsDataReport.motivo}`, 7, 112, { maxWidth: 200, align: 'justify', lineHeightFactor: 1.5 });
    doc.text(`${lsDataReport.recomendaciones}`, 7, 162, { maxWidth: 200, align: 'justify', lineHeightFactor: 1.5 });
