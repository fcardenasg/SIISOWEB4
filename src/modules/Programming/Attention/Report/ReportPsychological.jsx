...
const DataAssistance = ({ title, text, xsTitle = 2.5, xsText = 3.5 }) => {
    return (
        <Fragment>
...
const ReportPsychological = ({ id = 10 }) => {
    const { user } = useAuth();
    ...
    console.log("lsDataReport ", lsDataReport)
                                                    ...
                                                    <Grid container spacing={1}>
                                                        ...
                                                        <Grid item xs={9}>
                                                            <Grid container spacing={1}>
                                                                ...
                                                                <DataAssistance title="ANTIGUEDAD:" text={GetEdad(lsDataReport.fechaContrato)} />
                                            ...
                                            <Grid container spacing={2}>
                                                ...
                                                <Grid item xs={12}>
                                                    <Grid container spacing={1}>
                                                        ...
                                                        <Grid item xs={4}>
                                                            <Typography variant="h6"><b>ESTADO:</b> {lsDataReport.nameEstadoAsesoria}</Typography>
                                                        </Grid>
                                                    </Grid>
                                                </Grid>
