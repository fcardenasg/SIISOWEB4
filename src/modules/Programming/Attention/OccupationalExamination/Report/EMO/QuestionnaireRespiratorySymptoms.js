...
/* Pag. 1 */
export function pageQuestionnaireRespiratorySymptomsOne(doc, lsDataReport = [], lsDataUser = []) {
...
/* Pag. 2 */
export function pageQuestionnaireRespiratorySymptomsTwo(doc, lsDataReport = [], lsDataUser = []) {
...
/* Pag. 4 */
export function pageQuestionnaireRespiratorySymptomsFour(doc, lsDataReport = [], lsDataUser = []) {
  /* LISTA DE DATOS PACIENTE */
  doc.setFontSize(10);
  doc.setLineWidth(0.2);
  doc.setDrawColor(128, 128, 128);
