...
import { DeleteIndexNote, GetAllIndexNote } from 'api/clients/PersonalNotesClient';
...
const EnhancedTableToolbar = ({ numSelected, onClick }) => (
    ...
    >
        ...
        <Box sx={{ flexGrow: 1 }} />
        {numSelected > 0 && (
            <ValidateAction idAccion={AccionMenu.eliminar} idModulo={Modulo.Apuntesdeindexacion}>
...
const ListIndexNote = () => {
    ...
    const handleDelete = async () => {
        try {
            swal(ParamDelete).then(async (willDelete) => {
                if (willDelete) {
                    const result = await DeleteIndexNote(idCheck);
    ...
    return (
        <MainCard title="Lista de Apuntes de Indexación" content={false}>
                ...
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} lg={3} sx={{ textAlign: 'right' }}>
                        <Grid container spacing={2}>
                            <Grid item xs={6}>
                                <ValidateAction idAccion={AccionMenu.agregar} idModulo={Modulo.Apuntesdeindexacion}>
                                    <Button variant="contained" size="large" startIcon={<AddCircleOutlineOutlinedIcon />}
                                        onClick={() => navigate("/index-notes/add")}>
                                        {TitleButton.Agregar}
                                    </Button>
                                </ValidateAction>
                            </Grid>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="center">
                                            <ValidateAction idAccion={AccionMenu.actualizar} idModulo={Modulo.Apuntesdeindexacion}>
                                                <Tooltip title="Actualizar" onClick={() => navigate(`/index-notes/update/${row.id}`)}>
                                                    <IconButton size="large">
