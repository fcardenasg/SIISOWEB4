...
const TableConsulting = Loadable(lazy(() => import('./Tables/TableConsulting')));
const TableMedicalAttention = Loadable(lazy(() => import('./Tables/TableMedicalAttention')));
const TableEmo = Loadable(lazy(() => import('./Tables/TableEmo')));
const TableInfirmary = Loadable(lazy(() => import('./Tables/TableInfirmary')));
