...
import { TitleButton, DefaultValue, AccionMenu, Modulo } from 'components/helpers/Enums';
...
const EnhancedTableToolbar = ({ numSelected, onClick }) => (
    ...
    >
        ...
        <Box sx={{ flexGrow: 1 }} />
        {numSelected > 0 && (
            <ValidateAction idAccion={AccionMenu.eliminar} idModulo={Modulo.Rxtorax}>
...
const ListRXTORAX = () => {
    ...
    const [rxtorax, setRxtorax] = useState([]);
    ...
    const handleSelectAllClick = (event) => {
        ...
        if (event.target.checked) {
            const newSelectedId = rxtorax.map((n) => n.id);
    ...
    return (
        <MainCard title={<>Lista de RX de TORAX</>} content={false}>
                ...
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} lg={3} sx={{ textAlign: 'right' }}>
                        <Grid container spacing={2}>
                            <Grid item xs={6}>
                                <ValidateAction idAccion={AccionMenu.agregar} idModulo={Modulo.Rxtorax}>
            ...
            <TableContainer>
                {rxtorax.length === 0 ? <Cargando size={220} myy={6} /> :
                    <Table sx={{ minWidth: 750 }} aria-labelledby="tableTitle">
                        <EnhancedTableHead
                            ...
                            rowCount={rxtorax.length}
                            theme={theme}
                            selected={selected}
                            onClick={handleDelete}
                        />
                        <TableBody>
                            {stableSort(rxtorax, getComparator(order, orderBy))
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="center">
                                                <ValidateAction idAccion={AccionMenu.actualizar} idModulo={Modulo.Rxtorax}>
                                                    <Tooltip title="Actualizar" onClick={() => navigate(`/paraclinics/rxtorax/update/${row.id}`)}>
                                                        <IconButton size="large">
