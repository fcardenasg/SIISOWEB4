...
const UpdatePSA = () => {
    ...
    const handleClick = async (datos) => {
        try {
            const DataToUpdate = PutParaclinics(id, DefaultValue.PARACLINICO_PSA, documento,
                                    ...
                                    <Grid item xs={2.4}>
                                        <FormProvider {...methods}>
                                            <InputSelect
                                                ...
                                                label="Conducta"
                                                defaultValue={lsPsa.idConductaClasificacion}
                                                options={lsConducta}
                                                size={matchesXS ? 'small' : 'medium'}
                                                bug={errors}
                                            />
                                    ...
                                    <Grid item xs={2.4}>
                                        <FormProvider {...methods}>
                                            <InputSelect
                                                name="idConclusion"
                                                label="Conclusión"
                                                defaultValue={lsPsa.idConclusion}
                                    ...
                                    <Grid item xs={2.4}>
                                        <FormProvider {...methods}>
                                            <InputSelect
                                                name="idProveedor"
                                                label="Proveedor"
                                                defaultValue={lsPsa.idProveedor}
                                                options={lsProveedor}
                                                size={matchesXS ? 'small' : 'medium'}
                                                bug={errors}
                                            />
                            ...
                            <SubCard darkTitle>
                                <Grid container spacing={2}>
                                    <Grid item xs={12}>
                                        <FormProvider {...methods}>
                                            <InputText
                                                defaultValue={lsPsa.observacion}
                                                fullWidth
                                                name="observacion"
                                                label="Observaciones"
                                                size={matchesXS ? 'small' : 'medium'}
