...
const UpdateRNM = () => {
    ...
    return (
        <ValidateActionSkeleton idAccion={AccionMenu.actualizar} idModulo={Modulo.RNM}>
                                    ...
                                    <Grid item xs={2.4}>
                                        <FormProvider {...methods}>
                                            <InputSelect
                                                ...
                                                label="Conducta"
                                                defaultValue={lsRnm.idConductaClasificacion}
                                                options={lsConducta}
                                                size={matchesXS ? 'small' : 'medium'}
                                                bug={errors}
                                            />
                                    ...
                                    <Grid item xs={2.4}>
                                        <FormProvider {...methods}>
                                            <InputSelect
                                                name="idConclusion"
                                                label="Conclusión"
                                                defaultValue={lsRnm.idConclusion}
                                    ...
                                    <Grid item xs={2.4}>
                                        <FormProvider {...methods}>
                                            <InputSelect
                                                name="idProveedor"
                                                label="Proveedor"
                                                defaultValue={lsRnm.idProveedor}
                                                options={lsProveedor}
                                                size={matchesXS ? 'small' : 'medium'}
                                                bug={errors}
                                            />
                            ...
                            <SubCard darkTitle>
                                <Grid container spacing={2}>
                                    <Grid item xs={12}>
                                        <FormProvider {...methods}>
                                            <InputText
                                                defaultValue={lsRnm.observacion}
                                                fullWidth
                                                name="observacion"
                                                label="Observaciones"
                                                size={matchesXS ? 'small' : 'medium'}
