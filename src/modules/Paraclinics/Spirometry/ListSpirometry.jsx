...
const EnhancedTableToolbar = ({ numSelected, onClick }) => (
    ...
    >
        ...
        <Box sx={{ flexGrow: 1 }} />
        {numSelected > 0 && (
            <ValidateAction idAccion={AccionMenu.eliminar} idModulo={Modulo.Espirometria}>
...
const ListSpirometry = () => {
    ...
    return (
        <MainCard title="Lista de Espirometrías" content={false}>
                ...
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} lg={3} sx={{ textAlign: 'right' }}>
                        <Grid container spacing={2}>
                            <Grid item xs={6}>
                                <ValidateAction idAccion={AccionMenu.agregar} idModulo={Modulo.Espirometria}>
            ...
            <TableContainer>
                {spirometry.length === 0 ? <Cargando size={220} myy={6} /> :
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="center">
                                                <ValidateAction idAccion={AccionMenu.actualizar} idModulo={Modulo.Espirometria}>
