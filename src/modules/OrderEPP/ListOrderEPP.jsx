...
const EnhancedTableToolbar = ({ numSelected, onClick }) => (
    ...
    >
        ...
        <Box sx={{ flexGrow: 1 }} />
        {numSelected > 0 && (
            <ValidateAction idAccion={AccionMenu.eliminar} idModulo={Modulo.OrdenesEPP}>
...
const ListOrderEPP = () => {
    ...
    return (
        <MainCard title={<>Lista de ordenes EPP</>} content={false}>
                ...
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} lg={3.5} sx={{ textAlign: 'right' }}>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={5}>
                                <ValidateAction idAccion={AccionMenu.agregar} idModulo={Modulo.OrdenesEPP}>
            ...
            <TableContainer>
                {lsOrderEPP.length === 0 ? <Cargando size={140} /> :
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="center">
                                                <ValidateAction idAccion={AccionMenu.actualizar} idModulo={Modulo.OrdenesEPP}>
