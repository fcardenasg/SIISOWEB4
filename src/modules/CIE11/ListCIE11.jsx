...
const EnhancedTableToolbar = ({ numSelected, onClick }) => (
    ...
    >
        ...
        <Box sx={{ flexGrow: 1 }} />
        {numSelected > 0 && (
            <ValidateAction idAccion={AccionMenu.eliminar} idModulo={Modulo.CIE10}>
...
const ListCIE11 = () => {
    ...
    async function GetAll() {
        try {
            const lsServer = await GetAllCIE11();
            setCie11(lsServer.data);
    ...
    const handleSelectAllClick = (event) => {
        ...
        if (event.target.checked) {
            const newSelectedId = cie11.map((n) => n.id);
    ...
    return (
        <MainCard title="Lista de CIE10 / CIE11" content={false}>
                ...
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} lg={3.5} sx={{ textAlign: 'right' }}>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={5}>
                                <ValidateAction idAccion={AccionMenu.agregar} idModulo={Modulo.CIE10}>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="center">
                                                <ValidateAction idAccion={AccionMenu.actualizar} idModulo={Modulo.CIE10}>
