...
const ExportAssignment = ({ setOpcionBusqueda, opcionBusqueda, setSede, sede,
    ...
    async function getDataForExport() {
        try {
            ...
            const response = await axios.post(`${Url.Base}${Url.AsignacionInvestigacion}/excel`, parametros,
                {
                    responseType: 'blob',
                    headers: {
            ...
            if (response.data) {
                DownloadFileBlob(response.data, 'AsignacionInvestigacion');
            }
