...
const ListAPTCalificacion = () => {
    ...
    const handleDelete = async () => {
        try {
            swal(ParamDelete).then(
                async (willDelete) => {
                    if (willDelete) {
                        const result =
                            await DeleteAPTCalificacion(
                                idCheck
                            );
                                                ...
                                                >
                                                    <Tooltip title="Actualizar">
                                                        <IconButton
                                                            ...
                                                            onClick={() =>
                                                                navigate(
                                                                    `/apt-psychosocial/update/${row.id}`
                                                                )
                                                            }
                                                        >
                                                            <EditTwoToneIcon
