...
const EnhancedTableToolbar = ({ numSelected, onClick }) => (
    ...
    >
        ...
        <Box sx={{ flexGrow: 1 }} />
        {numSelected > 0 && (
            <ValidateAction idAccion={AccionMenu.eliminar} idModulo={Modulo.Catalogo}>
    ...
    return (
        <MainCard title="Lista de Catálogo" content={false}>
                ...
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} lg={3.5} sx={{ textAlign: 'right' }}>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={5}>
                                <ValidateAction idAccion={AccionMenu.agregar} idModulo={Modulo.Catalogo}>
            ...
            <TableContainer>
                ...
                {catalog.length === 0 ? <Cargando size={140} /> :
