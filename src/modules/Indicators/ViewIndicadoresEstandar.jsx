...
const ViewIndicadoresEstandar = () => {
    ...
    useEffect(() => {
        async function getAll() {
            try {
                const lsServer = await GetAllIndicadores(1);
    ...
    return (
        <Fragment>
            <MainCard title="Indicadores del área de salud ocupacional - modo estandar" secondary={
                <AnimateButton>
...
export default ViewIndicadoresEstandar;