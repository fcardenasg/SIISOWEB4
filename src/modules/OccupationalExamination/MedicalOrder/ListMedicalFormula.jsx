                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="center" sx={{ pr: 3 }}>
                                            <Tooltip title="Actualizar" onClick={() => {
                                                setNumberId(`${row.idRecetario}`);
                                                setNewMedicalFormula(false);
                                                setListMedicalFormula(false);
                                                setUpdateMedicalFormula(true);
                                            }}>
                                                <IconButton size="large">
...
ListMedicalFormula.propTypes = {
    setListMedicalFormula: PropTypes.any,
