...
import { GetExcelFramingham } from "api/clients/FraminghamClient";

const ExcelFramingham = ({ setSede, sede, setFechaInicio, fechaInicio, setFechaFin, fechaFin }) => {
    ...
    async function getDataForExport() {
        try {
            ...
            const lsServerExcel = await GetExcelFramingham(parametros);
...
export default ExcelFramingham;