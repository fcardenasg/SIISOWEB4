...
const ReportPsychologicalCounseling = () => {
            ...
            <Grid item xs={18} md={6} lg={12} ref={componentRef}>
                <SubCard darkTitle title={
                    <>
                        ...
                        <Typography variant="subtitle1">LISTADO DE ASESORÍAS PSICOLÓGICAS</Typography>
                    </>
                } secondary={<Logo />}>
...
export default ReportPsychologicalCounseling;