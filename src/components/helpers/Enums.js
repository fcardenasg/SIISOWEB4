export const CodCatalogo = {
    ...
    APTPH_CARGAFISICAOWAS: 3009,
    APTHIGIENE_EXIGENCIA_BIOMECANICA: 3002,
    APTHIGIENE_ACTIVIDAD: 4002,
    APTHIGIENE_CATEGORIAPORSEGMENTO: 4003,
    APTHIGIENE_FACTOR_ORGANIZACIONAL: 4004,
    APTHIGIENE_VALOR_REF_SEGMENTO: 4005,
    ...
    ALIENTOALCOHOLICO: 2013,
    ESTADOCONCIENCIA: 2012,
    ATENCION: 2011,
    FLUJOLENGUAJE: 2010,
    DISARTRIA: 2009,
    PUPILA: 2008,
    OTRASOPCIONES: 2007,
    REFLEJOSOSTEOTENDINOSOS: 2006,
    OPCIONESAUSENTEPRESENTE: 2005,
    CUANDOPOSITIVO: 2004,
    DETERMINACION: 2003,
...
export const Modulo = {
    ...
    Atencion: 2,
    Asesoriamedica: 3,
    Asesoriapsicologica: 4,
    Otrasasesorias: 5,
    Accidentedetrabajo: 6,
    Reintegro: 7,
    Medicinalaboral: 8,
    Ausentismolaboral: 9,
    Ordenesindividuales: 10,
    Detalleordenes: 11,
    Audiometria: 12,
    ...
    PSA: 19,
    Citologia: 20,
    Programaciondeordenes: 21,
    Indexacion: 22,
    Recetario: 23,
    Pruebadealcoholydroga: 24,
    Solicituddetaxi: 25,
    OrdenesEPP: 26,
    Conceptodeaptitud: 27,
    Framingham: 28,
    CorrespondenciaSolicitud: 29,
    SGSST: 30,
    ProductosMedicamento: 31,
    Pedidos: 32,
    Entrega: 33,
    Tipodecatalogo: 34,
    Catalogo: 35,
...
export const DefaultValue = {
    ...
    ATENCION_HISTORIA_EMBRIAGUEZ: 11128, /* Cambiar o revisar */
