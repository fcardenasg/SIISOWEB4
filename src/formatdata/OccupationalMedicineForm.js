...
export function PostOccupationalMedicine(cedula, resumenCaso = DefaultValue.SINREGISTRO_GLOBAL, fechaRetiro, segmentoAgrupado = DefaultValue.SINREGISTRO_GLOBAL,
    segmentoAfectado = DefaultValue.SINREGISTRO_GLOBAL, subsegmento = DefaultValue.SINREGISTRO_GLOBAL,
    codDx = '', nroFurel = '', regionInfoLaboral = DefaultValue.SINREGISTRO_GLOBAL, lateralidad = DefaultValue.SINREGISTRO_GLOBAL,
    entidadQueMotivaEnvio = DefaultValue.SINREGISTRO_GLOBAL, entidadDondeEnvia = DefaultValue.SINREGISTRO_GLOBAL, fechaEntrega, fechaEnvio, investigado = DefaultValue.SINREGISTRO_GLOBAL,
    observaciones = '', fechaCalificacionEps, origenEps = DefaultValue.SINREGISTRO_GLOBAL, noSolicitudARL = '', fechaCalifiOrigenARL, origenARL = DefaultValue.SINREGISTRO_GLOBAL,
    fechaCalificacionPclARL, pclARL = 0,
