export function PostWorkAbsenteeism(cedula, incapacidad, nroIncapacidad, fechaExpedicion, departamento, ciudadExpedicion,
...
export function PutWorkAbsenteeism(id_Inc, cedula, incapacidad, nroIncapacidad, fechaExpedicion, departamento, ciudadExpedicion,
    tipoIncapacidad, contingencia, fechaInicio, fechaFin, diasSinLaborar, dx, dxFinal, estadoCaso, segmentoAgrupado, segmentoAfectado,
    subsegmento, idTipoSoporte, idCategoria,
