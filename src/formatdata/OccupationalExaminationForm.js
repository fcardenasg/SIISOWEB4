export function PostOccupationalExamination(
    ...
    anioVacuna1IM, anioVacuna2IM, anioVacuna3IM, anioVacuna4IM, anioVacuna5IM,
    idRefuerzoIM, anioVacuna6IM,
    fumaHB = false, cigarrillosDiasFumaHB, aniosCigaFumaHB, mesesCigaFumaHB, observacionFumaHB,
    fumabaHB = false, cigarrillosDiasFumabaHB, aniosCigaFumabaHB, mesesCigaFumabaHB, observacionFumabaHB,
    practicaDeporteHB = false, idFrecuenciaDeporteHB, idCualDeporteHB,
    observacionPracticaDeporHB, hobbiesPasatiempoHB = false, cualHobbiesHB,
    consumeBebidasAlcoholicasHB = false, idFrecuenciaBebidaAlHB, cualBebidasAlHB,
    fobiasHB = false, tipoFobiaHB, cualFobiaHB,

    menarquiaGO, idCiclosGO, duracionGO, amenoreaGO = false, disminureaGO = false,
    leucoreaGO = false, vidaMaritalGO, vidaObstetricaGO, ggo, pgo, ago, csgo, vgo,
    fupgo = null, furgo = null, etsgo = false, cualgo,
    quisteOvariosBiomasGO = false, endometriosisGO = false, epigo = false, planificaGO = false,
    idMetodoGO, ultimoAnioCitologiaGO, idResultadoGO, observacionesGO,
    ...
    taSentadoEF, taAcostadoEF, pulsoEF, fcef, fref, temperaturaEF, pesoEF, tallaEF, imcef,
    clasificacionEF, idBiotipoEF,
    ...
    dx1, dx2, dx3, observacionID, recomendacionesID, idConceptoActitudID,

    fechaConceptoNETA = null, conceptoAplazadoNETA,
    conceptoActitudNETA, idConceptoEspacioConfinado,
    motivoAplazoNETA, descripcionResultadoNETA, recomendacionesNETA,
    remitidoNETA, remididoDondeNETA,

    idRiesgoCardiovascularNEMTA, idClasificacionNEMTA,
    ...
    observacionesNEMTA, conceptoActitudMedicoNEMTA,

    fechaFRA = null, tencionFRA, idTencionArterialFRA,
    idAntecedenteCardiovascularFRA, idDeporteFRA, idBebidaFRA,
    fechaLaboratorioFRA = null, colesterolTotalFRA, hdlfra, triglicericosFRA, idMetabolicoFRA,
    glisemiaFRA, fumaFRA, observacionFRA,
    ...
    historiaOcupB3SintR, historiaOcupCSintR = false, historiaOcupC1SintR,
    historiaOcupC2SintR, historiaOcupC3SintR, historiaOcupD1SintR,
