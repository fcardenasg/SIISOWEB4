export function PostOccupationalExamination(
    ...
    anioVacuna6IM,
    fumaHB,
    cigarrillosDiasFumaHB,
    aniosCigaFumaHB,
    mesesCigaFumaHB,
    observacionFumaHB,
    fumabaHB,
    cigarrillosDiasFumabaHB,
    aniosCigaFumabaHB,
    mesesCigaFumabaHB,
    observacionFumabaHB,
    practicaDeporteHB,
    idFrecuenciaDeporteHB,
    idCualDeporteHB,
    observacionPracticaDeporHB,
    hobbiesPasatiempoHB,
    cualHobbiesHB,
    consumeBebidasAlcoholicasHB,
    idFrecuenciaBebidaAlHB,
    cualBebidasAlHB,
    fobiasHB,
    tipoFobiaHB,
    cualFobiaHB,
    ...
    etsgo,
    cualgo,
    quisteOvariosBiomasGO,
    endometriosisGO,
    epigo,
    planificaGO,
    idMetodoGO,
    ultimoAnioCitologiaGO,
    idResultadoGO,
    cabezaRS,
    ojosRS,
    oidosRS,
    ...
    cuellosEF,
    inspeccionToraxEF,
    auscultacionCardiacaEF,
    auscultacionRespiratoriaEF,
    inspeccionAbdomenEF,
    palpacionAbdomenEF,
    exploracionHigadoEF,
    exploracionVasoEF,
    exploracionRinionesEF,
    anillosInguinalesEF,
    anilloUmbilicalEF,
    genitalesExternosEF,
    regionAnalEF,
    tactoRectalEF,
    tactoVaginalEF,
    extremidadesSuperioresEF,
    extremidadesInferioresEF,
    pulsosEF,
    columnaVertebralEF,
    articulacionesEF,
    especifiqueEMEFU,
    ...
    rotRotuleanoEFU,
    extencionEFU,
    sensibilidadCaraAnteriorEFU,
    eversionPiesEFU,
    sensibilidadCaraLateralEFU,
    rotAquileanoEFU,
    signoLasegueEFU,
    indiceWellsEFU,
    observacionEFU,
    fechaRxToraxEPA,
    resultadoRxToraxEPA,
    observacionesRxToraxEPA,
    fechaEspirometriaEPA,
    resultadoEspirometriaEPA,
    observacionesEspirometriaEPA,
    fechaAudiometriaEPA,
    resultadoAudiometriaEPA,
    observacionesAudiometriaEPA,
    fechaVisiometriaEPA,
    resultadoVisiometriaEPA,
    observacionesVisiometriaEPA,
    fechaLaboratorioClinicoEPA,
    resultadoLaboratorioClinicoEPA,
    observacionesLaboratorioClinicoEPA,
    fechaCuestionarioSintomaEPA,
    resultadoCuestionarioSintomaEPA,
    observacionesCuestionarioSintomaEPA,
    fechaEkgEPA,
    resultadoEkgEPA,
    observacionesEkgEPA,
    fechaRnmLumbosacraEPA,
    resultadoRnmLumbosacraEPA,
    observacionesRnmLumbosacraEPA,
    fechaRnmCervicalEPA,
    resultadoRnmCervicalEPA,
    observacionesRnmCervicalEPA,
    observacionEPA,
    dxID,
    observacionID,
    recomendacionesID,
    idConceptoActitudID,
    fechaConceptoNETA,
    conceptoAplazadoNETA,
    conceptoActitudNETA,
    motivoAplazoNETA,
    descripcionResultadoNETA,
    recomendacionesNETA,
    remitidoNETA,
    remididoDondeNETA,
    idRiesgoCardiovascularNEMTA,
    idClasificacionNEMTA,
    idMenorEdadNEMTA,
    idMujerEmbarazadaNEMTA,
    idArimiaNEMTA,
    idEnfermedadNEMTA,
    idHistoriaNEMTA,
    idHipertensionNEMTA,
    idHipertrigliceridemiaNEMTA,
    idCifrasNEMTA,
    idDiabetesNEMTA,
    idDislipidemiaNEMTA,
    idDiagnosticoNEMTA,
    idRiesgoCardiovascular1NEMTA,
    idRiesgoCardiovascular2NEMTA,
    idHipertiroidismoNEMTA,
    idAlteracionAuditivaNEMTA,
    idVertigoAlteracionesNEMTA,
    idEpilegsiaNEMTA,
    idCegueraTemporalNEMTA,
    idHistoriaFobiasNEMTA,
    idTranstornoPsiquiatricoNEMTA,
    idLimitacionesNEMTA,
    idObesidadMorbidaNEMTA,
    idDeformaTemporalNEMTA,
    idOtrasAlteracionesNEMTA,
    observacionesNEMTA,
    conceptoActitudMedicoNEMTA,
    fechaFRA,
    tencionFRA,
    idTencionArterialFRA,
    idAntecedenteCardiovascularFRA,
    idDeporteFRA,
    idBebidaFRA,
    fechaLaboratorioFRA,
    colesterolTotalFRA,
...
export function PutOccupationalExamination(id, idHistoriaLaboral, documento, fecha, idAtencion,
    ...
    vacunasIM, anioVacuna1IM, anioVacuna2IM, anioVacuna3IM, anioVacuna4IM, anioVacuna5IM, anioVacuna6IM,
