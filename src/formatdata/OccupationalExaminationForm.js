...
export function PostOccupationalExamination(
    ...
    fechaRxToraxEPA = FormatDate(new Date()), resultadoRxToraxEPA = 4017, observacionesRxToraxEPA = "",
    fechaEspirometriaEPA = FormatDate(new Date()), resultadoEspirometriaEPA = 4017, observacionesEspirometriaEPA = "",
    fechaAudiometriaEPA = FormatDate(new Date()), resultadoAudiometriaEPA = 4017, observacionesAudiometriaEPA = "",
    fechaVisiometriaEPA = FormatDate(new Date()), resultadoVisiometriaEPA = 4017, observacionesVisiometriaEPA = "",
    fechaLaboratorioClinicoEPA = FormatDate(new Date()), resultadoLaboratorioClinicoEPA = 4017, observacionesLaboratorioClinicoEPA = "",
    fechaCuestionarioSintomaEPA = FormatDate(new Date()), resultadoCuestionarioSintomaEPA = 4017, observacionesCuestionarioSintomaEPA = "",
    fechaEkgEPA = FormatDate(new Date()), resultadoEkgEPA = 4017, observacionesEkgEPA = "",
    fechaRnmLumbosacraEPA = FormatDate(new Date()), resultadoRnmLumbosacraEPA = 4017, observacionesRnmLumbosacraEPA = "",
    fechaRnmCervicalEPA = FormatDate(new Date()), resultadoRnmCervicalEPA = 4017, observacionesRnmCervicalEPA = "", observacionEPA = "",
